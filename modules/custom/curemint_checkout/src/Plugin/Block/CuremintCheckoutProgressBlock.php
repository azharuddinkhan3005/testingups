...
namespace Drupal\curemint_checkout\Plugin\Block;
 ...
 *
 * @Block(
 *   id = "curemint_commerce_checkout_progress",
 *   admin_label = @Translation("Curemint Checkout progress"),
 *   category = @Translation("Commerce")
 * )
 */
class CuremintCheckoutProgressBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  public function build() {
    ...
    // Add exception for Complete step
    unset($visible_steps['complete']);
